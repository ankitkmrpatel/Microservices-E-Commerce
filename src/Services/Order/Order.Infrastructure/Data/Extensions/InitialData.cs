...
internal class InitialData
{
    ...
    new List<Customer>
    {
        Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "ankit", "ankit2006@duck.com"),
    ...
    public static IEnumerable<Domain.Models.Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("ankit", "kumar", "ankit2006@duck.com", "330, Delhi", "Delhi", "India", "110037");
